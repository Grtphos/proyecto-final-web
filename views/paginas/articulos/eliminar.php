...
<div class="row">
    ...
    <div class="col-sm-10">
        ...
        <form action="<?= RUTA_URL; ?>/articulos/eliminar/<?= $datos['id'] ?>" id="formArticulo" method="POST" enctype="multipart/form-data">
        <!--<div class="form-row">-->
        <div class="col-md-12">
            <p>Estas seguro de querer eliminar el Articulo <?= isset($datos['idArticulo'])?$datos['idArticulo']:''; ?> con nombre <?= isset($datos['nombreArticulo'])?$datos['nombreArticulo']:''; ?></p>
        </div>
