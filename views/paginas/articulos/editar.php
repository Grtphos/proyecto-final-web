...
<div class="row">
    ...
    <div class="col-sm-10">
        <form action="<?= RUTA_URL; ?>/articulos/editar/<?= $datos['id'] ?>" id="formArticulo" method="POST" enctype="multipart/form-data">
            <!--<div class="form-row">-->
                <h2 class="text-center">Datos de la Maquinaria</h2>
                <div class="col-md-2">
                    <label for="idArticulo">ID Articulo</label>
                    <input type="text" class="form-control" id="idArticulo" placeholder="ID Articulo" required="required" name="idArticulo" maxlength="10" value="<?= isset($datos['idArticulo'])?$datos['idArticulo']:'' ?>">
                </div>
                <hr>
                <div class="col-md-4">
                    <label for="nombreArticulo">Nombre del Articulo</label>
                    <input type="text" class="form-control" id="nombreArticulo" placeholder="Nombre del Articulo" required="required" name="nombreArticulo" maxlength="130" value="<?= isset($datos['nombreArticulo'])?$datos['nombreArticulo']:'' ?>">
                </div>
                <hr>
                <div class="col-md-4">     
                    <label for="precioArticulo">Precio del Articulo</label>
                    <input type="text" class="form-control" id="precioArticulo" placeholder="Precio del Articulo" required="required" name="precioArticulo" maxlength="12" value="<?= isset($datos['precioArticulo'])?$datos['precioArticulo']:'' ?>">
                </div>
                <hr>
            <div class="col-md-6">
